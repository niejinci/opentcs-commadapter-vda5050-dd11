...
import static org.opentcs.commadapter.vehicle.vda5050.v1_1.CommAdapterMessages.SEND_INSTANT_ACTIONS_PARAM_ACTIONS;
...
import static org.opentcs.commadapter.vehicle.vda5050.v1_1.CommAdapterMessages.SEND_INSTANT_ACTIONS_TYPE;
...
public class CommAdapterMessageMapper {
  ...
  public Optional<InstantActions> toInstantActions(VehicleCommAdapterMessage message) {
    ...
    try {
      ...
      return Optional.of(new InstantActions().setInstantActions(actions));
    }
